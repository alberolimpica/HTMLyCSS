...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/backend/llyv.min.js":[function(require,module,exports) {
/**
 *
 * llyv.js
...
(function () {
  ...
  for (var i = 0; i < videos.length; i++) {
    ...
    videos[i].appendChild(llyvPlayBtn); // Construct thumbnail image

    var img = document.createElement('img');
    img.src = "https://img.youtube.com/vi/" + videos[i].dataset.id + "/hqdefault.jpg";
    videos[i].appendChild(img); // Construct iframe
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/backend/llyv.min.js"], null)
//# sourceMappingURL=/llyv.min.be1aee3d.js.map